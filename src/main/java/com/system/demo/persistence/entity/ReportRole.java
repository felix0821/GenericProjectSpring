 ...
 */
@Entity
@Table(name = "report_role", catalog = "ucps_system", schema = "public")
@NamedQueries({
...
public class ReportRole implements Serializable {
    ...
    public String toString() {
        return "com.system.demo.persistence.entity.ReportRole[ reportRolePK=" + reportRolePK + " ]";
    }
